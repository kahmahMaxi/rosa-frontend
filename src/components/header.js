...
const Header = () => {
  ...
  const {  connected, publicKey, disconnect } =
    useWalletFromAdapter();
  ...
  return (
    <div className="">
      {(windowWidth < 1100 && showsidebar) ||
      (windowWidth < 850 && showrightbar) ? (
        <BarsDrop dropPress={setAlltoNull} />
      ) : null}

      <Notifications />

      {path.pathname !== "/auth" && path.pathname !== '/' && path.pathname !== '/ring' ? (
          ...
          <div className="main-header-inner flex row align-center justify-space-between">
            <div className="">
              ...
              {windowWidth < 1100 ? (
                <div className="flex row align-center">
                  <div
                    className="menu-bar flex justify-center align-center cursor-pointer"
            ...
            <div className="flex row align-center gap-13">
              {windowWidth < 1100 && windowWidth > 500 ? (
                <p
                  className="header-sos-btn inter cursor-pointer"
              ...
              {windowWidth > 500 ? (
                <div
                  className="connect-wallet-btn flex row align-center cursor-pointer"
              ...
              {windowWidth < 850 ? (
                <div
                  className="me-icon flex justify-center align-center cursor-pointer"
